...
exports.generate = async function (title, docs, filename, tmpl, resolveLinks) {
    ...
    // await fs.mkdir(dirname, function (err) {
    //     if (err) {
    //         // return console.log("Failed to create directory : ", dirname, filename)
    //     }
    // });
